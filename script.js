...
let context = canvas.getContext('2d'); //.... é aonde vai ser criado toda a parte visual do jogo

let box = 28;
let snake = []; // cobra criada no meio do canvas
snake[0] = {
    x: 8 * box,
    y: 8 * box
}
...
let food ={ //reposicionamento da maçã
...
let jogo = setInterval(iniciarJogo, 80); //velocidade do
